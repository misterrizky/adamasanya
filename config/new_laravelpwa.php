...
//         ],
//         'shortcuts' => auth()->check() ? (
//             in_array(auth()->user()->getRoleNames()->first(), ['Konsumen', 'Onboarding']) ? [
//                 [
//                     'name' => 'Transaksi',
...
//                     ]
//                 ]
//             ] : (in_array(auth()->user()->getRoleNames()->first(), ['Super Admin', 'Owner']) ? [
//                 [
//                     'name' => 'Transaksi',
...
//                     'description' => 'Kelola produk elektronik',
//                     'url' => '/admin/product-branch',
//                     'icons' => [
//                         'src' => '/media/icons/icon-72x72.png',
//                         'purpose' => 'any'
//                     ]
...
//                     'description' => 'Kelola cabang dan stok',
//                     'url' => '/admin/branch',
//                     'icons' => [
//                         'src' => '/media/icons/icon-72x72.png',
//                         'purpose' => 'any'
...
//             [
//                 'name' => 'Cari Barang',
//                 'description' => 'Cari barang elektronik yang Anda inginkan',
//                 'url' => '/home',
//                 'icons' => [
//                     'src' => '/media/icons/icon-72x72.png',
//                     'purpose' => 'any'
...
//             [
//                 'name' => 'Promo',
//                 'description' => 'Lihat penawaran menarik',
//                 'url' => '/promo',
//                 'icons' => [
//                     'src' => '/media/icons/icon-72x72.png',
//                     'purpose' => 'any'

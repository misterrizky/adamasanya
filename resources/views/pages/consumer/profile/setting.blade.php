    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-10">
        <div class="card shadow-sm mb-5">
            ...
            <div id="pengaturan_akun" class="collapse show">
                <a href="{{ route('profile.edit') }}" wire:navigate class="card card-dashed hover-elevate-up shadow-sm text-decoration-none">
                ...
                <a href="{{ route('profile.address') }}" wire:navigate class="card card-dashed hover-elevate-up shadow-sm parent-hover text-decoration-none">
                    <div class="card-body d-flex align-items-center">
                        <i class="ki-filled ki-geolocation fs-3x"></i>
                        <div class="ms-3">
                            <div class="text-gray-700 parent-hover-primary fs-4 fw-bold">
                                Daftar Alamat
                            </div>
                ...
                <a href="{{ route('profile.family') }}" wire:navigate class="card card-dashed hover-elevate-up shadow-sm parent-hover text-decoration-none">
                    <div class="card-body d-flex align-items-center">
                        <i class="ki-filled ki-people fs-3x"></i>
                        <div class="ms-3">
                            <div class="text-gray-700 parent-hover-primary fs-4 fw-bold">
                                Daftar Keluarga
                            </div>
                            <div class="text-gray-500 parent-hover-primary fs-5 mt-1">
                                Atur keluarga agar dapat mengakses menu sewa
                            </div>
                        </div>
                    </div>
                </a>
                <a href="{{ route('profile.security') }}" wire:navigate class="card card-dashed hover-elevate-up shadow-sm parent-hover text-decoration-none">
                    <div class="card-body d-flex align-items-center">
                ...
                <a href="{{ route('profile.notification') }}" wire:navigate class="card card-dashed hover-elevate-up shadow-sm parent-hover text-decoration-none">
                    <div class="card-body d-flex align-items-center">
                ...
                <a href="{{ route('profile.privacy') }}" wire:navigate class="card card-dashed hover-elevate-up shadow-sm parent-hover text-decoration-none">
                    <div class="card-body d-flex align-items-center">

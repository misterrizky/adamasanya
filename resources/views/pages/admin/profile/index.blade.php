    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-10">
        <div class="container py-4">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3" data-aos="fade-down">
                ...
                <div>
                    <a href="" class="btn btn-link btn-color-muted btn-active-color-primary" wire:navigate>
                        <i class="ki-filled ki-delivery-24 fs-3x me-2"></i>
                    </a>
                    <a href="{{ route('admin.profile.setting') }}" class="btn btn-link btn-color-muted btn-active-color-primary" wire:navigate>
            ...
            <!-- Menu Lain -->
            <div class="p-3 rounded-box shadow-sm">
                <div class="row text-center">
                    @role('Super Admin|Owner')
                    <div class="col">
                        <a href="{{ route('admin.branch') }}" wire:navigate>
                            <i class="ki-filled ki-shop fs-3x"></i><br><small>Kelola Cabang</small>
                        </a>
                    </div>
                    @elserole('Cabang')
                    <div class="col">
                        <a href="{{ route('admin.branch-schedule') }}" wire:navigate>
                            <i class="ki-filled ki-shop fs-3x"></i><br><small>Jam Operasional</small>
                        </a>
                    </div>
                    @endrole
                    <div class="col d-none">

                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-1">
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            <h2 class="h3 fw-bold mb-0">
                                <span class="text-primary">{{ $this->totalBrand }}</span> Kategori Ditemukan
                                @if($this->search)
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px symbol-circle me-3">
                                                <img src="{{ asset('storage/' . $brand->thumbnail) }}" alt="{{ $brand->name }}" class="w-100">
                                            </div>
                                            <div>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a 
                                                wire:navigate
                                                href="{{ route('admin.brand.edit', ['slug' => $brand]) }}" 
